-- Baseline schema, generated by `drizzle-kit pull` against the database
-- Prisma had built. drizzle-kit emits it commented out; it is uncommented here
-- so a fresh database (CI, a new environment) is created by this migration.
-- Databases that already had the schema are baselined instead of running it --
-- see src/db/migrate.js.
...
CREATE UNIQUE INDEX "user_roles_user_id_role_id_key" ON "user_roles" USING btree ("user_id","role_id");--> statement-breakpoint
...
CREATE INDEX "hotels_city_country_idx" ON "hotels" USING btree ("city","country");--> statement-breakpoint
CREATE UNIQUE INDEX "hotel_amenities_hotel_id_amenity_id_key" ON "hotel_amenities" USING btree ("hotel_id","amenity_id");--> statement-breakpoint
CREATE UNIQUE INDEX "amenities_name_key" ON "amenities" USING btree ("name");--> statement-breakpoint
CREATE UNIQUE INDEX "room_type_amenities_room_type_id_amenity_id_key" ON "room_type_amenities" USING btree ("room_type_id","amenity_id");--> statement-breakpoint
CREATE UNIQUE INDEX "rooms_room_type_id_room_number_key" ON "rooms" USING btree ("room_type_id","room_number");--> statement-breakpoint
CREATE INDEX "room_rates_room_type_id_start_date_end_date_idx" ON "room_rates" USING btree ("room_type_id","start_date","end_date");--> statement-breakpoint
CREATE UNIQUE INDEX "customers_email_key" ON "customers" USING btree ("email");--> statement-breakpoint
CREATE UNIQUE INDEX "customers_user_id_key" ON "customers" USING btree ("user_id");--> statement-breakpoint
CREATE UNIQUE INDEX "bookings_booking_number_key" ON "bookings" USING btree ("booking_number");--> statement-breakpoint
CREATE INDEX "bookings_check_in_check_out_idx" ON "bookings" USING btree ("check_in","check_out");--> statement-breakpoint
CREATE INDEX "bookings_status_idx" ON "bookings" USING btree ("status");--> statement-breakpoint
CREATE INDEX "booking_rooms_room_id_check_in_check_out_idx" ON "booking_rooms" USING btree ("room_id","check_in","check_out");--> statement-breakpoint
CREATE UNIQUE INDEX "invoices_invoice_number_key" ON "invoices" USING btree ("invoice_number");--> statement-breakpoint
CREATE UNIQUE INDEX "tour_itineraries_tour_package_id_day_number_key" ON "tour_itineraries" USING btree ("tour_package_id","day_number");--> statement-breakpoint
CREATE UNIQUE INDEX "tour_bookings_booking_number_key" ON "tour_bookings" USING btree ("booking_number");--> statement-breakpoint
CREATE UNIQUE INDEX "vehicles_registration_number_key" ON "vehicles" USING btree ("registration_number");--> statement-breakpoint
CREATE INDEX "audit_logs_entity_entity_id_idx" ON "audit_logs" USING btree ("entity","entity_id");--> statement-breakpoint
CREATE UNIQUE INDEX "settings_agency_id_key_key" ON "settings" USING btree ("agency_id","key");
