  ...
  const columns = [
    {
      key: 'name',
      header: 'Package',
      render: (row) => <Link to={`/admin/tours/packages/${row.id}/edit`}>{row.name}</Link>,
    },
    ...
    { key: 'status', header: 'Status', render: (row) => <StatusBadge status={row.status} /> },
    {
      ...
      render: (row) => (
        <div className="inline-actions">
          {canUpdate && (
            <Button variant="ghost" onClick={() => navigate(`/admin/tours/packages/${row.id}/edit`)}>
              Edit
            </Button>
          )}
          {canDelete && (
    ...
    <div>
      ...
      <div className="page-header">
        ...
        <div className="page-actions">
          {canCreate && (
            <Button as={Link} to="/admin/tours/packages/new">
              + New Package
            </Button>
          )}
        </div>
