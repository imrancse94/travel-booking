  ...
  const columns = [
    {
      key: 'name',
      header: 'Room Type',
      render: (row) => <Link to={`/admin/rooms/room-types/${row.id}/edit`}>{row.name}</Link>,
    },
    ...
    { key: 'totalRooms', header: 'Total Rooms' },
    {
      ...
      render: (row) => (
        <div className="inline-actions">
          {canUpdate && (
            <Button variant="ghost" onClick={() => navigate(`/admin/rooms/room-types/${row.id}/edit`)}>
              Edit
            </Button>
          )}
          {canDelete && (
    ...
    <div>
      ...
      <div className="page-header">
        ...
        <div className="page-actions">
          {canCreate && (
            <Button as={Link} to="/admin/rooms/room-types/new">
              + New Room Type
            </Button>
          )}
        </div>
